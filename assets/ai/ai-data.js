...
export function buildSystemPrompt(mode) {
  ...
  if (mode === "nukrax") {
    return `You are the NUKRAX Assistant, embedded on the NUKRAX trading-tools website.
...
If asked something outside NUKRAX's scope (unrelated general knowledge, coding help, etc.), say this mode is focused on NUKRAX and suggest switching to General AI mode via the 3-dot menu.
...
${kb}`;
  ...
  return `You are a helpful, general-purpose AI assistant embedded in a small chat widget on the NUKRAX website. Answer whatever the user asks, clearly and concisely, the way a knowledgeable, friendly assistant would. You are not restricted to NUKRAX topics in this mode.`;
}
...
export const TUTORIAL_STEPS = [
  {
    title: "Welcome to NUKRAX AI",
    icon: "◆",
    body: "This is your assistant for everything on this site — Expert Advisors, setup, risk, contact, or just a normal conversation."
  },
  {
