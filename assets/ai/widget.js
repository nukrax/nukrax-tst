...
if (!document.getElementById(ROOT_ID)) {
  ...
  @media(max-width:600px){ #${ROOT_ID}{ right:16px; bottom:calc(34px + env(safe-area-inset-bottom, 0px)); } }
  ...
  .nkx-panel{
    ...
    width:380px; max-width:calc(100vw - 32px); height:min(580px, 74vh);
    background:var(--panel,#0A0F13); border:1px solid var(--line,#1B2328);
  ...
  @media(max-width:600px){
    .nkx-panel{ width:calc(100vw - 32px); height:min(76vh, 620px); border-radius:20px; }
  }
  ...
  .nkx-msg{ max-width:86%; font-size:14px; line-height:1.55; }
  ...
  .nkx-send-btn{
    ...
    border:none; color:var(--black,#030507); cursor:pointer;
